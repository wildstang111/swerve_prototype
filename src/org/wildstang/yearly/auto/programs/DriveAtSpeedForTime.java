...
{
   protected final int DISTANCE = Core.getConfigManager().getConfig().getInt(this.getClass().getName() + ".Distance", 40);
   protected final double SPEED = Core.getConfigManager().getConfig().getDouble(this.getClass().getName() + ".Speed", .5);
